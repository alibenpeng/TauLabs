...
/* init sensor queue registration */
	...
	HwMyFirstFCMPU6000DLPFGet(&hw_mpu6000_dlpf);
	enum pios_mpu60x0_filter mpu6000_dlpf = \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_256) ? PIOS_MPU60X0_LOWPASS_256_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_188) ? PIOS_MPU60X0_LOWPASS_188_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_98) ? PIOS_MPU60X0_LOWPASS_98_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_42) ? PIOS_MPU60X0_LOWPASS_42_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_20) ? PIOS_MPU60X0_LOWPASS_20_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_10) ? PIOS_MPU60X0_LOWPASS_10_HZ : \
	    (hw_mpu6000_dlpf == HWMYFIRSTFC_MPU6000DLPF_5) ? PIOS_MPU60X0_LOWPASS_5_HZ : \
	    pios_mpu6000_cfg.default_filter;
	PIOS_MPU6000_SetLPF(mpu6000_dlpf);

	uint8_t hw_mpu6000_samplerate;
	HwMyFirstFCMPU6000RateGet(&hw_mpu6000_samplerate);
	uint16_t mpu6000_samplerate = \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_200) ? 200 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_333) ? 333 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_500) ? 500 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_666) ? 666 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_1000) ? 1000 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_2000) ? 2000 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_4000) ? 4000 : \
	    (hw_mpu6000_samplerate == HWMYFIRSTFC_MPU6000RATE_8000) ? 8000 : \
...
#if defined(PIOS_INCLUDE_HMC5883)
	{
		...
		if (Magnetometer == HWMYFIRSTFC_MAGNETOMETER_INTERNAL) {
		...
		if (Magnetometer == HWMYFIRSTFC_MAGNETOMETER_EXTERNALI2CUART1) {
			// init sensor
		...
		if (Magnetometer == HWMYFIRSTFC_MAGNETOMETER_EXTERNALI2CUART3) {
			// init sensor
		...
		if (Magnetometer == HWMYFIRSTFC_MAGNETOMETER_EXTERNALI2CUART1 ||
			Magnetometer == HWMYFIRSTFC_MAGNETOMETER_EXTERNALI2CUART3)
		{
